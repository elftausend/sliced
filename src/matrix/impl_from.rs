use custos::{Alloc, Buffer, Device, Shape, OnNewBuffer};
...
impl<'a, T: Copy, D: Alloc<T> + OnNewBuffer<T, D, ()>, const N: usize> From<(&'a D, usize, usize, [T; N])>
    for Matrix<'a, T, D>
{
    #[inline]
...
impl<'a, T: Copy, D: Alloc<T> + OnNewBuffer<T, D, ()>> From<(&'a D, usize, usize, Vec<T>)> for Matrix<'a, T, D> {
